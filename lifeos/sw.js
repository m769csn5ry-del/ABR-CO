...
const SHELL = [
  ...
  './src/domain/calendar.js', './src/domain/notes.js', './src/domain/rules.js', './src/domain/insights.js', './src/domain/stats.js',
  './src/domain/search.js', './src/domain/planner.js', './src/domain/weekly.js', './src/domain/focus.js',
  './src/services/timer.js', './src/services/notifications.js', './src/services/ics.js', './src/services/csv.js', './src/services/bank.js', './src/services/auth.js',
