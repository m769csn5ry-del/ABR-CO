...
/* Page d'aboutissement. Elle n'est atteinte qu'après un paiement réel : c'est
   le webhook du prestataire qui crée la commande et redirige ici avec sa
...
function Confirmation() {
  ...
  return (
    <>
      ...
      <h1 className="mt-5 text-h2 font-semibold tracking-[-0.025em]">Merci, c&apos;est noté</h1>
      <p className="measure mt-5 text-lead text-mineral">
        Ta commande <span className="font-medium text-ink">{ref}</span> est enregistrée. Tu
        reçois le récapitulatif par e-mail, puis le numéro de suivi dès l&apos;expédition.
